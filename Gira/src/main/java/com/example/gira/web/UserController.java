...
public class UserController {
    ...
    public String loginConfirm(@Valid UserLoginBindingModel userLoginBindingModel,
        ...
        UserServiceModel userServiceModel = userService.findUserByEmail(userLoginBindingModel.getEmail());
        ...
        userService.loginUser(userServiceModel.getId(), userLoginBindingModel.getEmail());
        return "redirect:/";
    }
